...
import './commissionssettings.scss';

const CommissionsSettingsPage = () => {
    return (
        <div className='commissions-settings-container'>
            <div className='content-container'>
                <div className='content-header'>
                    <div className='header-content'>
                        <span className='header-link' onClick={() => window.location.href = '/setup'}>Settings</span>
                        <span className='header-title'>Commissions</span>
                    </div>
...
export default CommissionsSettingsPage;