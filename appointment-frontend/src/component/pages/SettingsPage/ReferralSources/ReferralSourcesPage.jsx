...
import './referralsources.scss';

const ReferralSourcesPage = () => {
    return (
        <div className='referral-sources-container'>
            <div className='content-container'>
                <div className='content-header'>
                    <div className='header-content'>
                        <span className='header-link' onClick={() => window.location.href = '/setup'}>Settings</span>
                        <span className='header-title'>Referral Sources</span>
                    </div>
                    <div className='header-action'>
                        <button className='action-save'>Add new source</button>
                    </div>
                </div>
                <div className='content-details'>
                    ...
                    <div className='content-item'>
                        ...
                        <div className='item-detail'>
                            <span className='item-name'>Fresha</span>
                        </div>
                        <div className='item-status'>
                            <span className='badge success'>ACTIVE</span>
                        </div>
                    ...
                    <div className='content-item'>
                        ...
                        <div className='item-detail'>
                            <span className='item-name'>Book Now Link</span>
                        </div>
                        <div className='item-status'>
                            <span className='badge success'>ACTIVE</span>
                        </div>
